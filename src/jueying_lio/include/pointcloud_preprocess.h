#ifndef jueying_lio_POINTCLOUD_PROCESSING_H
#define jueying_lio_POINTCLOUD_PROCESSING_H
...
enum class LidarType { AVIA = 1, VELO32, OUST64 , RSLIDAR, LIVOX_STD};
...
class PointCloudPreprocess {
   ...
   private:
    ...
    void RslidarHandler(const sensor_msgs::PointCloud2::ConstPtr &msg);
