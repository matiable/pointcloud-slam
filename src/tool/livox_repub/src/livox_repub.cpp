...
std::vector<livox_repub::CustomMsgConstPtr> livox_data;
void LivoxMsgCbk1(const livox_repub::CustomMsgConstPtr& livox_msg_in) {
...
int main(int argc, char** argv) {
  ...
  ros::Subscriber sub_livox_msg1 = nh.subscribe<livox_repub::CustomMsg>(
      "/livox/lidar", 100, LivoxMsgCbk1);
  pub_pcl_out1 = nh.advertise<sensor_msgs::PointCloud2>("/livox_points", 100);
